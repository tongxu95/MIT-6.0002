...
class RectangularRoom(object):
    ...
    def __init__(self, width, height, dirt_amount):
        ...
        self.height = height
        self.tiles = {}
        for i in range(math.floor(self.width)):
            for j in range(math.floor(self.height)):
    ...
    def clean_tile_at_position(self, pos, capacity):
        ...
        """
        if capacity <= self.tiles[(math.floor(pos.x), math.floor(pos.y))]:
            self.tiles[math.floor(pos.x), math.floor(pos.y)] -= capacity
        else:
    ...
    def is_position_in_room(self, pos):
        ...
        """
        return (math.floor(pos.x), math.floor(pos.y)) in self.tiles
...
class FurnishedRoom(RectangularRoom):
    ...
    def get_num_tiles(self):
        ...
        """
        #self.tiles is a dictionary, self.furniture_tiles is a list
...
class FaultyRobot(Robot):
    ...
    def update_position_and_clean(self):
        ...
        """
        #if the robot is not faulty, treat like a StandardRobot
        ...
        #otherwise, randomly change the robot's direction
        else:
            self.set_robot_direction(random.random() * 360)
...
def run_simulation(num_robots, speed, capacity, width, height, dirt_amount, min_coverage, num_trials,
    ...
    for i in range(num_trials):
        #visualize = ps3_visualize.RobotVisualization(num_robots, width, height, False) 
        ...
        #initialize num_robots of robot_type class objects and store them in a list
        robots = []
        ...
        #clean the room while ratio of clean tiles to total tiles is less than minimum coverage:
        while (room.get_num_cleaned_tiles()/room.get_num_tiles()) < min_coverage:
            timestep += 1
            for robot in robots:
                robot.update_position_and_clean()
                #visualize.update(room, robots)
        
        #visualize.done()
        
        sum_timestep += timestep

    #return how many time-steps are needed on average to clean the room. 
    return sum_timestep/num_trials
...
#print ('avg time steps for a StandardRobot to clean 80% of a 20x20 room is: ' + str(run_simulation(1, 1.0, 1, 20, 20, 3, 0.8, 50, StandardRobot)))
#print ('avg time steps for a StandardRobot to clean 80% of a 20x20 room is: ' + str(run_simulation(1, 1.0, 1, 20, 20, 3, 0.8, 50, FaultyRobot)))

# 2) How does the performance of the two robot types compare when two of each
#       robot cleans 80% of rooms with dimensions 
#       10x30, 20x15, 25x12, and 50x6?

#print ('avg time steps for two StandardRobot to clean 80% of a 10x30 room is: ' + str(run_simulation(2, 1.0, 1, 10, 30, 3, 0.8, 50, StandardRobot)))
#print ('avg time steps for two StandardRobot to clean 80% of a 10x30 room is: ' + str(run_simulation(2, 1.0, 1, 10, 30, 3, 0.8, 50, FaultyRobot)))
#print ('avg time steps for two StandardRobot to clean 80% of a 20x15 room is: ' + str(run_simulation(2, 1.0, 1, 20, 15, 3, 0.8, 50, StandardRobot)))
#print ('avg time steps for two StandardRobot to clean 80% of a 20x15 room is: ' + str(run_simulation(2, 1.0, 1, 20, 15, 3, 0.8, 50, FaultyRobot)))
#print ('avg time steps for two StandardRobot to clean 80% of a 25x12 room is: ' + str(run_simulation(2, 1.0, 1, 25, 12, 3, 0.8, 50, StandardRobot)))
#print ('avg time steps for two StandardRobot to clean 80% of a 25x12 room is: ' + str(run_simulation(2, 1.0, 1, 25, 12, 3, 0.8, 50, FaultyRobot)))
#print ('avg time steps for two StandardRobot to clean 80% of a 50x6 room is: ' + str(run_simulation(2, 1.0, 1, 50, 6, 3, 0.8, 50, StandardRobot)))
#print ('avg time steps for two StandardRobot to clean 80% of a 50x6 room is: ' + str(run_simulation(2, 1.0, 1, 50, 6, 3, 0.8, 50, FaultyRobot)))
